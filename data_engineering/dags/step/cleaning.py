...
def preprocessing(): 
    ...
    # Cleaning value for 'marital' column
    ...
    # Cleaning value for 'education' column
    ...
    # Cleaning value for 'default' column
    ...
    # Cleaning value for 'housing' column
    ...
    # Cleaning value for 'contact' column
    ...
    # Cleaning value for 'loan' column
    ...
    # Cleaning value for 'month' colummn
    ...
    # Cleaning value for 'day_of_week' column
    ...
    # Cleaning value for 'poutcome' colummn
